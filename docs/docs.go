...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/slurm/sacct/job/user/{user}/": {
            "post": {
                "description": "获取作业会计信息，包括作业ID、用户、状态、提交时间等详细信息",
                "consumes": [
                    "application/json"
